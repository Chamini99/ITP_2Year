...
contentPane.setLayout(null);
		...
		lbl_logo.setIcon(new ImageIcon(Home.class.getResource("/IT20119744/assets/logosu.png")));
		contentPane.add(lbl_logo);
		...
		lbl_image1.setIcon(new ImageIcon(Home.class.getResource("/IT20119744/assets/people.png")));
		contentPane.add(lbl_image1);
		...
		lbl_image2.setIcon(new ImageIcon(Home.class.getResource("/IT20119744/assets/staffmgt.png")));
		contentPane.add(lbl_image2);
		...
		lbl_image3.setIcon(new ImageIcon(Home.class.getResource("/IT20119744/assets/doctormgt.png")));
		contentPane.add(lbl_image3);
		...
		lbl_image4.setIcon(new ImageIcon(Home.class.getResource("/IT20119744/assets/supplymgt.png")));
		contentPane.add(lbl_image4);
		...
		lbl_image5.setIcon(new ImageIcon(Home.class.getResource("/IT20119744/assets/deliverymgt.png")));
		contentPane.add(lbl_image5);
		...
		lbl_image6.setIcon(new ImageIcon(Home.class.getResource("/IT20119744/assets/adminmgt.png")));
		contentPane.add(lbl_image6);
		...
		lblNewLabel_3.setIcon(new ImageIcon(Home.class.getResource("/IT20119744/assets/homebg.jpg")));
		contentPane.add(lblNewLabel_3);
