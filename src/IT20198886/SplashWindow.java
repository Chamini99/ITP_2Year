...
public class SplashWindow extends JFrame {
	...
	public SplashWindow() {
        ...
        lblNewLabel.setIcon(new ImageIcon(SplashWindow.class.getResource("/IT20198886/Assets/splashbackground.jpg")));
        contentPane.add(lblNewLabel);
		...
		label.setIcon(new ImageIcon("/IT20198886/Assets/splashbackground.jpg"));
